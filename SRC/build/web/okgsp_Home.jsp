                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-7">
                                <div class="welcome-text mb-50">
                                    ...
                                    <h3 data-animation="fadeInLeftBig" data-delay="400ms" data-duration="1s">Search Over Encrypted  <span>Cloud Data </span></h3>
                                    </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-7">
                                <div class="welcome-text mb-50">
                                   <h2 data-animation="fadeInLeftBig" data-delay="200ms" data-duration="1s">Sanitizer<br> Dashboard</h2>
