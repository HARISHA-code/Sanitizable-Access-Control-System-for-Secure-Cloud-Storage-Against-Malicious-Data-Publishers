                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav" style="color:black;">
                                    ...
                                    <li><a href="Send_Files.jsp">Send File Request to Proxy</a></li>
                        ...
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12 col-md-9 col-lg-7">
                                <div class="welcome-text mb-50">
                                    <h2 data-animation="fadeInLeftBig" data-delay="200ms" data-duration="1s">Privacy Preserving<br> Data Sharing <br></h2>
                                    <h3 data-animation="fadeInLeftBig" data-delay="400ms" data-duration="1s">  for Collaborative Cloud Environment<span> </span> </h3>
